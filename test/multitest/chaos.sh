...
./peer -p nodes.map -i 1 -c etc/A.chunks -f etc/C.masterchunks -m 3 &
...
echo "GET etc/A.chunks tmp/foo.foo8" | ./peer -p nodes.map -i 8 -c etc/C.chunks -f etc/C.masterchunks -m 3 -n &

echo "GET etc/B.chunks tmp/foo.foo9" | ./peer -p nodes.map -i 9 -c etc/C.chunks -f etc/C.masterchunks -m 3 -n &

echo "GET etc/A.chunks tmp/foo.foo10" | ./peer -p nodes.map -i 10 -c etc/C.chunks -f etc/C.masterchunks -m 3 -n &

echo "GET etc/B.chunks tmp/foo.foo11" | ./peer -p nodes.map -i 11 -c etc/C.chunks -f etc/C.masterchunks -m 3 -n &

sleep 10

./peer -p nodes.map -i 2 -c etc/C.chunks -f etc/C.masterchunks -m 3 &
